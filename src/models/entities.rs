...
pub struct GroupJoinRequest {
    ...
    pub status: Option<String>,// 枚举pending, accepted, rejected, expired
...
pub struct GroupMember {
    ...
    pub do_not_disturb: bool,// 免打扰
    pub tag: Option<String>,// 分组标签
    pub remark: Option<String>,// 备注
    pub is_pinned: bool,// 置顶状态
}
...
pub struct GroupMessage {
    ...
    #[sqlx(rename = "type")]
    pub mes_type: String,// 枚举类型 text image file voice video link emoji annoucement
    pub mentioned_uids: Option<serde_json::Value>,// Json格式
    pub quote_msg_id: Option<String>,// 消息引用
    pub is_announcement: bool,// 是否是群公告
}
...
pub struct PrivateChat {
    ...
    pub create_time: Option<NaiveDateTime>,
    pub is_pinned_by_uid1: bool,// uid1置顶状态
    pub is_pinned_by_uid2: bool,// uid2置顶状态
}
...
pub struct PrivateMessage {
    ...
    pub is_read: bool,
    #[sqlx(rename = "type")]
    pub mes_type: String,// 枚举类型 text image file voice video link emoji
}
...
pub struct Friends {
    ...
    pub create_time: Option<NaiveDateTime>,
    pub is_blacklist: bool,// 黑名单，拒收消息
